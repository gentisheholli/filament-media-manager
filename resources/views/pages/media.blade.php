                    ...
                    <x-filament::modal  width="3xl" slide-over>
                        <x-slot name="trigger" class="w-full h-full">
                            <div class="flex flex-col justify-start gap-4 border dark:border-gray-700 rounded-lg shadow-sm p-2 w-full h-full">
                                <div class="flex flex-col items-center justify-left  p-4 h-full">
                                ...
                                <div>
                                    <div class="flex flex-col justify-between border-t dark:border-gray-700 p-4">
                                        ...
                                        <div class="flex flex-col justify-start">
                                            <p>
                                                <button type="button"
                                                        class="btn btn-outline-primary btn-sm text-xs truncate d-block w-100 copy-url"
                                                        data-url="{{ $item->getUrl() }}"
                                                        style="position: static; border-radius: 8px; background-color: #cda247; color: #fff; padding: 5px 35px; font-weight: bold;">
                                                    Copy Image URL
                                                </button>
                                            </p>
                                            <span id="copied-message" class="hidden text-green-500 text-xs mt-2">Copied</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
